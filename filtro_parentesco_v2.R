...
while (nrow(df_35) != 0) {
  ...
  cover_35$Categoria = gsub("Distrofia de Retina", "AAAAAAAA", cover_35$Categoria)
  cover_35$Categoria[is.na(cover_35$Categoria)] = "NA"
  cover_35 = cover_35[order(cover_35$V2, cover_35$Categoria, decreasing = TRUE),]
...
df_out = df_out[,c("muestra", "num_relaciones", "muestras_emparentadas", "pi_hat", "z0", "z1", "z2", "N_MISS", "N_GENO", "F_MISS", "Categoria")]
